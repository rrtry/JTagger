...
import static com.rrtry.utils.IntegerUtils.fromUInt32LE;

public class OggPage implements Component {

    public static final int PAGE_MAX_SIZE    = 255 * 255;
    public static final int SEGMENT_MAX_SIZE = 255;
    ...
    private int index = 0;
    private byte[] pageData = new byte[PAGE_MAX_SIZE];
    private byte[] bytes;
    ...
    public String toString() {
        return String.format(
                ...
                getHeader().isFreshPage(),
                getHeader().isFirstPage(),
                getHeader().isLastPage(),
                getHeader().getGranulePosition(),
                getHeader().getSerialNumber(),
                getHeader().getChecksum(),
                getHeader().getPageSequenceNumber(),
                getHeader().getPageSegments()
